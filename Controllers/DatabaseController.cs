...
using net6_api_docker_sqlserver_tls_fix.Data;

namespace net6_api_docker_sqlserver_tls_fix.Controllers;
...
public class DatabaseController : ControllerBase
{
    ...
    public async Task<IActionResult> SeedDatabase()
    {
        try
        {
            ...
            var testEntity = new net6_api_docker_sqlserver_tls_fix.Models.TestEntity
            {
